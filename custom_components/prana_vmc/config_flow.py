"""Config flow for Prana VMC integration."""
...
STEP_USER_DATA_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_NAME, default="Prana VMC"): str,
    }
)
...
class PranaConfigFlow(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Prana VMC."""
    ...
    async def async_step_user(
        ...
        if user_input is not None:
            ...
            name = user_input.get(CONF_NAME, "Prana VMC")
    ...
    async def async_step_zeroconf(
        ...
        name = discovery_info.properties.get("label", "Prana VMC")
